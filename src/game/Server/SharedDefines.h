...
enum SpellAttributes
{
    ...
    SPELL_ATTR_NEGATIVE_1                      = 0x04000000,// 26 Many negative spells have this attribute
...
enum SpellAttributesEx6
{
    ...
    SPELL_ATTR_EX6_CAN_TARGET_POSSESSED_FRIENDS  = 0x00000400,// 10 NYI!
    SPELL_ATTR_EX6_NOT_IN_RAID_INSTANCE          = 0x00000800,// 11 Castable while caster is on vehicle
    ...
    SPELL_ATTR_EX6_UNK15                         = 0x00008000,// 15 Only 54368, 67892
    SPELL_ATTR_EX6_UNK16                         = 0x00010000,// 16
    SPELL_ATTR_EX6_UNK17                         = 0x00020000,// 17 Mount spell
    ...
    SPELL_ATTR_EX6_UNK19                         = 0x00080000,// 19 Only 47488, 50782
    ...
    SPELL_ATTR_EX6_UNK22                         = 0x00400000,// 22 Only 72054
    SPELL_ATTR_EX6_UNK23                         = 0x00800000,// 23 not set in 3.0.3
    SPELL_ATTR_EX6_CAN_TARGET_UNTARGETABLE       = 0x01000000,// 24
    SPELL_ATTR_EX6_UNK25                         = 0x02000000,// 25 Exorcism, Flash of Light
    SPELL_ATTR_EX6_UNK26                         = 0x04000000,// 26 Related to player castable positive buff
    SPELL_ATTR_EX6_UNK27                         = 0x08000000,// 27 Not set in 3.0.3
    SPELL_ATTR_EX6_UNK28                         = 0x10000000,// 28 Death Grip
    SPELL_ATTR_EX6_NO_DONE_PCT_DAMAGE_MODS       = 0x20000000,// 29 Do not apply damage mods (usually in cases where it has already been applied)
    SPELL_ATTR_EX6_UNK30                         = 0x40000000,// 30 not set in 3.0.3
    SPELL_ATTR_EX6_IGNORE_CATEGORY_COOLDOWN_MODS = 0x80000000,// 31 Spells with this attribute skip applying modifiers to category cooldowns
};
